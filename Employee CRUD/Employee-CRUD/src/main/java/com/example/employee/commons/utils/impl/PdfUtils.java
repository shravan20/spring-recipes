package com.example.employee.commons.utils.impl;
...
public class PdfUtils {
    ...
    public <T extends PdfGeneratorDto> void generatePdf(List<T> dto, String fileName) throws FileNotFoundException {
